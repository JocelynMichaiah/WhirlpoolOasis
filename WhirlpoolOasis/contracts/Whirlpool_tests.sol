//the only difference between the original and this one is
//that balances is public. This is for the purpose of testing with Hardhat
//as you cannot automatically grab values from private variables
...
contract Whirlpool_tests {
    ...
    function deposit(address new_address) public payable {
        console.log("deposit called", new_address);
    ...
    function withdraw(address withdraw_address, uint value) public {
        console.log("withdraw called for,from ", withdraw_address, msg.sender);
